...
public class AssetInstallTask : Runnable.Runnable
{
    ...
    private readonly Furnace.Minecraft.Data.GameManifest.GameManifest _gameManifest;
    private readonly DirectoryInfo _directoryInfo;
    private const string AssetUrl = "https://resources.download.minecraft.net/{0}/{1}";

    public AssetInstallTask(Furnace.Minecraft.Data.GameManifest.GameManifest gameManifest, DirectoryInfo gameDir)
    {
